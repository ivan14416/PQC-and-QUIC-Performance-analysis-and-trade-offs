...
#define ALG_NAME OQS_SIG_alg_dilithium_5 // <== Change to e.g., OQS_SIG_alg_dilithium_5 for Dilithium5
#define ALG_DIR "dilithium5"             // <== Folder name for results, adjust accordingly
