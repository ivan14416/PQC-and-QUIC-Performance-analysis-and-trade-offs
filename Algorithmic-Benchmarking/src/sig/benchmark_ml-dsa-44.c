...
#define ALG_NAME OQS_SIG_alg_ml_dsa_44 // <== Change to e.g., OQS_SIG_alg_dilithium_5 for Dilithium5
#define ALG_DIR "ml_dsa_44"            // <== Folder name for results, adjust accordingly
