...
#define ALG_NAME OQS_SIG_alg_falcon_512 // <== Change to e.g., OQS_SIG_alg_dilithium_5 for Dilithium5
#define ALG_DIR "falcon-512"            // <== Folder name for results, adjust accordingly
