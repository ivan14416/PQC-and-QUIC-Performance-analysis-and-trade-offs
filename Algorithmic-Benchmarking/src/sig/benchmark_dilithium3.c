...
#define ALG_NAME OQS_SIG_alg_dilithium_3 // <== Change to e.g., OQS_SIG_alg_dilithium_5 for Dilithium5
#define ALG_DIR "dilithium3"             // <== Folder name for results, adjust accordingly
